...
COPY public.posts (id, author_id, text, created_date, updated_date) FROM stdin;
\.
...
--
-- Name: votes votes_voter_id_post_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.votes
    ADD CONSTRAINT votes_voter_id_post_id_key UNIQUE (voter_id, post_id);
